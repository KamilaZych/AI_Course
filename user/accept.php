    ...
    <main class="login-body" data-vide-bg="../assets/img/login-bg.mp4">
        <!-- Login Admin -->
            ...
            <div class="login-form">
                ...
                <h3 class="info">Czy na pewno chcesz usunąć konto?</h3>
                <h3 class="link_back"><a href="../lib/deactive_account/deactive-bg.php">Tak</a></h3>
                <h3 class="link_back"><a href="account.php">Nie</a></h3>
