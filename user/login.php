...
<body>
    ...
    <main class="login-body" data-vide-bg="../assets/img/login-bg.mp4">
        <!-- Login Admin -->
        <form class="form-default" action="../lib/login/login-bg.php" method="POST">
            ...
            <div class="login-form">
                ...
                <div class="form-input">
                    <span class="inccorect-date"><?php session_start(); echo $_SESSION['error'];unset($_SESSION['error']);?></span>
                </div>
                <div class="form-input">
                ...
                <div class="form-input">
                    ...
                    <input type="password" name="pass" placeholder="Hasło" required value = <?php session_start(); echo $_SESSION['login_pass'];?>> 
                </div>
                <div class="form-input pt-30">
                    <input type="submit" name="submit" value="login">
                </div>
                
                <a href="register.php" class="registration">Nie masz konta? Zarejestruj się!</a>
            </div>
        </form>
        <!-- /end login form -->
    </main>
